  ...
  return {
    ...
    connections: [
      ...
      // The Simulation Offload (The "Decoupled" Magic)
      {
        ...
        sourceId: "ec2-app",
        targetId: "sqs",
        label: "Enqueue Sim Job",
      },
      {
        id: "conn-8",
        sourceId: "sqs",
        targetId: "lambda-worker",
      ...
      {
        id: "conn-9",
        sourceId: "lambda-worker",
        targetId: "rds-mysql",
        label: "Write Financials",
      },
      {
        id: "conn-10",
        sourceId: "lambda-worker",
    ...
    pricing: [
      {
        ...
        description: "db.t3.medium (Multi-AZ)",
        cost: "$136.00",
      },
      {
        service: "Amazon EC2 + ALB",
        description: "2x t3.small + Load Balancer",
        cost: "$60.00",
      },
      {
        service: "Amazon ElastiCache",
        description: "cache.t3.micro (Redis)",
        cost: "$17.00",
      },
      {
        service: "AWS Lambda & SQS",
        description: "Simulation Compute (On-demand)",
        cost: "$12.50",
      },
      {
        service: "Amazon S3",
      ...
      },
      {
        ...
        description: "MAU < 50,000 (Free Tier)",
        cost: "$0.00",
      },
      {
        service: "Secrets & CloudWatch",
...
// --- Main API Endpoint ---
// Handle both /api/generate-architecture and /generate-architecture paths
// (Vercel rewrites /api/* to /api/server, so we need to handle the path correctly)
...
// Also handle the direct path (in case Vercel routing strips /api)
app.post("/generate-architecture", (req, res) => {
  console.log("Received request at /generate-architecture");
  console.log("Request body:", req.body);
